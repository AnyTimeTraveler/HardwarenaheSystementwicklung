...
EXTRN NUMBER (GAMESCREEN_LEN, GAMESCREEN_ROWS)
PUBLIC PFUN_ADD_PIECE, PFUN_REMOVE_PIECE, PFUN_CHECK_COLLISION, PFUN_DRAW_BACKGROUND
PUBLIC PFUN_FIND_FULL_ROW, PFUN_MOVE_ROWS_DOWN, PFUN_CLEAR_SCREEN, PFUN_FILL_SCREEN
