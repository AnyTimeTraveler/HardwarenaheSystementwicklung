...
; BEGIN Register
PUBLIC REGISTER_BANK_0_BEGIN, REGISTER_BANK_1_BEGIN, CLOCK_SAMPLES_BEGIN, CLOCK_SAMPLES_END, REGISTER_BANK_2_BEGIN, REGISTER_BANK_3_BEGIN

REGISTER_BANK_0_BEGIN       DATA 0x00
REGISTER_BANK_1_BEGIN       DATA 0x08
CLOCK_SAMPLES_BEGIN         DATA REGISTER_BANK_1_BEGIN
CLOCK_SAMPLES_END           DATA REGISTER_BANK_1_BEGIN + 6
...
PUBLIC BIT_BAUDRATE_DETECTING, BIT_BAUD_ERROR_FLAG, BIT_MOVE_LEFT, BIT_MOVE_RIGHT, BIT_MOVE_DOWN, BIT_MOVE_ROTATE_LEFT, BIT_MOVE_ROTATE_RIGHT, BIT_PIECE_ON_BOARD, BIT_KEYBOARD_BREAK
