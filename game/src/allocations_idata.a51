...
; BEGIN Internal RAM
PUBLIC VIRTUAL_KEYBOARD_INPUT, KEYBOARD_INPUT_BYTE, GAMETICK_SUB_COUNTER, CURRENT_LEVEL, CURRENT_PIECE_INDEX, CURRENT_PIECE_ROT_INDEX, CURRENT_PIECE_V_POS, CURRENT_PIECE_H_POS, SCREEN_REFRESH_CURRENT_ROW, KEYBOARD_TIMER_RELOAD, DEBUG
