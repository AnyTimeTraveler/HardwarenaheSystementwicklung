...
EXTRN DATA (GAMESTATE, CURRENT_LEVEL, CURRENT_PIECE_INDEX, CURRENT_PIECE_ROT_INDEX, CURRENT_PIECE_V_POS, GAMETICK_SUB_COUNTER)
EXTRN NUMBER (GS_FIRST_RUN, GS_PRE_GAME, GS_PLAYING, GS_ROW_CLEARING, GS_LOST)
EXTRN BIT (BIT_RUN_GAMETICK, BIT_CURRENT_COLOR)
PUBLIC PJMP_GAMELOOP, PJMPI_SUB_GAMETICK, PFUN_MOVE_LEFT, PFUN_MOVE_RIGHT, PFUN_ROTATE_RIGHT, PFUN_RESET_GAME
